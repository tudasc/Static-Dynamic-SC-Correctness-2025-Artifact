module attributes {dlti.dl_spec = #dlti.dl_spec<i1 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %30 = llvm.alloca %c1_i32 x !llvm.struct<"struct.dim3", (i32, i32, i32)> {alignment = 4 : i64} : (i32) -> !llvm.ptr
    ...
    %40 = llvm.call @nvshmem_team_my_pe(%c2_i32) : (i32) -> i32
    %41 = llvm.call @cudaSetDevice(%40) : (i32) -> i32
    %42 = llvm.call @nvshmem_my_pe() : () -> i32
    %43 = llvm.call @nvshmem_n_pes() : () -> i32
    %44 = arith.cmpi ne, %43, %c2_i32 : i32
    scf.if %44 {
      %71 = llvm.call @printf(%8, %43, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
      llvm.call @nvshmem_global_exit(%c1_i32) : (i32) -> ()
    }
    %45 = llvm.call @nvshmem_malloc(%c4_i64) : (i64) -> !llvm.ptr
    %46 = llvm.call @nvshmem_malloc(%c4_i64) : (i64) -> !llvm.ptr
    %47 = llvm.getelementptr inbounds %30[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %47 {alignment = 4 : i64} : i32, !llvm.ptr
    %48 = llvm.getelementptr inbounds %30[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %48 {alignment = 4 : i64} : i32, !llvm.ptr
    %49 = llvm.getelementptr inbounds %30[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %49 {alignment = 4 : i64} : i32, !llvm.ptr
    %50 = llvm.getelementptr inbounds %31[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %50 {alignment = 4 : i64} : i32, !llvm.ptr
    %51 = llvm.getelementptr inbounds %31[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %51 {alignment = 4 : i64} : i32, !llvm.ptr
    %52 = llvm.getelementptr inbounds %31[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %52 {alignment = 4 : i64} : i32, !llvm.ptr
    %53 = llvm.call @cudaMemset(%45, %c0_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    %54 = llvm.call @cudaMemset(%46, %c1_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %55 = llvm.load %30 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %56 = llvm.load %31 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %55, %32 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %56, %33 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %57 = llvm.load %30 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %58 = llvm.load %31 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %57, %34 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %58, %35 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    llvm.store %45, %17 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %46, %18 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %17, %21 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %59 = llvm.getelementptr %21[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %18, %59 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %0, %19 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %0, %20 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    %60 = llvm.call @nvshmem_my_pe() {convergent, no_unwind} : () -> i32
    %61 = arith.cmpi eq, %60, %c0_i32 : i32
    scf.if %61 {
      llvm.call @nvshmem_int_get_nbi(%46, %45, %c1_i64, %c1_i32) {convergent, no_unwind} : (!llvm.ptr, !llvm.ptr, i64, i32) -> ()
    }
    ...
    %62 = arith.cmpi eq, %42, %c0_i32 : i32
    scf.if %62 {
      %71 = llvm.call @cudaMemcpy(%29, %46, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
      %72 = llvm.load %29 {alignment = 4 : i64} : !llvm.ptr -> i32
      %73 = llvm.call @printf(%10, %72) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32) -> i32
      llvm.call @nvshmem_barrier_all() : () -> ()
      %74 = llvm.load %30 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      %75 = llvm.load %31 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      llvm.store %74, %36 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %75, %37 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      ...
      llvm.call @nvshmem_barrier_all() : () -> ()
      %71 = llvm.load %30 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      %72 = llvm.load %31 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      llvm.store %71, %38 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %72, %39 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %63 = llvm.call @cudaMemcpy(%28, %45, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %64 = llvm.call @cudaMemcpy(%29, %46, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %65 = llvm.load %29 {alignment = 4 : i64} : !llvm.ptr -> i32
    %66 = llvm.load %28 {alignment = 4 : i64} : !llvm.ptr -> i32
    %67 = llvm.call @printf(%11, %42, %65, %66) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %68 = llvm.load %28 {alignment = 4 : i64} : !llvm.ptr -> i32
    %69 = llvm.load %29 {alignment = 4 : i64} : !llvm.ptr -> i32
    %70 = llvm.call @printf(%12, %42, %68, %69) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_free(%45) : (!llvm.ptr) -> ()
    llvm.call @nvshmem_free(%46) : (!llvm.ptr) -> ()
