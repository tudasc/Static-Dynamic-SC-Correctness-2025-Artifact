module attributes {dlti.dl_spec = #dlti.dl_spec<i1 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %8 = llvm.mlir.addressof @_Z42__device_stub__nvshmem_quiet_kernelWrapperv : !llvm.ptr
    %9 = llvm.mlir.addressof @mlir.llvm.nameless_global_2 : !llvm.ptr
    %c1_i32 = arith.constant 1 : i32
    ...
    %13 = llvm.mlir.addressof @".str.2" : !llvm.ptr
    %14 = llvm.mlir.addressof @".str.3" : !llvm.ptr
    %15 = llvm.call @__cudaRegisterFatBinary(%3) : (!llvm.ptr) -> !llvm.ptr
    llvm.store %15, %2 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %16 = llvm.call @__cudaRegisterFunction(%15, %4, %5, %5, %c-1_i32, %11, %11, %11, %11, %11) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    %17 = llvm.call @__cudaRegisterFunction(%15, %6, %7, %7, %c-1_i32, %11, %11, %11, %11, %11) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    %18 = llvm.call @__cudaRegisterFunction(%15, %8, %9, %9, %c-1_i32, %11, %11, %11, %11, %11) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    llvm.call @__cudaRegisterFatBinaryEnd(%15) : (!llvm.ptr) -> ()
    %19 = llvm.call @atexit(%1) : (!llvm.ptr) -> i32
    ...
    %31 = llvm.alloca %c1_i32 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
    %32 = llvm.alloca %c1_i32 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
    %33 = llvm.alloca %c1_i32 x !llvm.array<2 x ptr> {alignment = 16 : i64} : (i32) -> !llvm.ptr
    %34 = llvm.alloca %c1_i32 x !llvm.struct<"struct.dim3", (i32, i32, i32)> {alignment = 4 : i64} : (i32) -> !llvm.ptr
    %35 = llvm.alloca %c1_i32 x !llvm.struct<"struct.dim3", (i32, i32, i32)> {alignment = 4 : i64} : (i32) -> !llvm.ptr
    ...
    %44 = llvm.call @nvshmem_team_my_pe(%c2_i32) : (i32) -> i32
    %45 = llvm.call @cudaSetDevice(%44) : (i32) -> i32
    %46 = llvm.call @nvshmem_my_pe() : () -> i32
    %47 = llvm.call @nvshmem_n_pes() : () -> i32
    %48 = arith.cmpi ne, %47, %c2_i32 : i32
    scf.if %48 {
      %82 = llvm.call @printf(%10, %47, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
      llvm.call @nvshmem_global_exit(%c1_i32) : (i32) -> ()
    }
    %49 = llvm.call @nvshmem_malloc(%c4_i64) : (i64) -> !llvm.ptr
    %50 = llvm.call @nvshmem_malloc(%c4_i64) : (i64) -> !llvm.ptr
    llvm.store %49, %33 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %51 = llvm.getelementptr inbounds %33[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %50, %51 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %52 = llvm.getelementptr inbounds %34[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %52 {alignment = 4 : i64} : i32, !llvm.ptr
    %53 = llvm.getelementptr inbounds %34[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %53 {alignment = 4 : i64} : i32, !llvm.ptr
    %54 = llvm.getelementptr inbounds %34[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %54 {alignment = 4 : i64} : i32, !llvm.ptr
    %55 = llvm.getelementptr inbounds %35[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %55 {alignment = 4 : i64} : i32, !llvm.ptr
    %56 = llvm.getelementptr inbounds %35[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %56 {alignment = 4 : i64} : i32, !llvm.ptr
    %57 = llvm.getelementptr inbounds %35[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %57 {alignment = 4 : i64} : i32, !llvm.ptr
    %58 = llvm.call @cudaMemset(%49, %c0_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    %59 = llvm.call @cudaMemset(%50, %c1_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %60 = llvm.load %34 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %61 = llvm.load %35 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %60, %36 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %61, %37 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.intr.lifetime.start 16, %27 : !llvm.ptr
    llvm.intr.lifetime.start 16, %28 : !llvm.ptr
    llvm.store %0, %27 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %0, %28 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %62 = llvm.load %34 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %63 = llvm.load %35 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %64 = llvm.getelementptr inbounds %33[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2 x ptr>
    llvm.store %62, %38 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %63, %39 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    %65 = llvm.load %64 {alignment = 8 : i64} : !llvm.ptr -> !llvm.ptr
    %66 = llvm.getelementptr %64[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    %67 = llvm.load %66 {alignment = 8 : i64} : !llvm.ptr -> !llvm.ptr
    ...
    llvm.store %65, %20 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %67, %21 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %20, %24 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %68 = llvm.getelementptr %24[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %21, %68 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %0, %22 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %0, %23 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    %69 = llvm.call @nvshmem_my_pe() {convergent, no_unwind} : () -> i32
    %70 = arith.cmpi eq, %69, %c0_i32 : i32
    scf.if %70 {
      llvm.call @nvshmem_int_get_nbi(%67, %65, %c1_i64, %c1_i32) {convergent, no_unwind} : (!llvm.ptr, !llvm.ptr, i64, i32) -> ()
    }
    ...
    %71 = arith.cmpi eq, %46, %c0_i32 : i32
    scf.if %71 {
      %82 = llvm.call @cudaMemcpy(%32, %50, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
      %83 = llvm.load %32 {alignment = 4 : i64} : !llvm.ptr -> i32
      %84 = llvm.call @printf(%12, %83) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32) -> i32
      llvm.call @nvshmem_quiet() : () -> ()
      %85 = llvm.load %34 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      %86 = llvm.load %35 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      llvm.store %85, %40 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %86, %41 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.intr.lifetime.start 16, %29 : !llvm.ptr
      llvm.intr.lifetime.start 16, %30 : !llvm.ptr
      llvm.store %0, %29 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %0, %30 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.call @nvshmem_quiet() {convergent, no_unwind} : () -> ()
      llvm.intr.lifetime.end 16, %29 : !llvm.ptr
      llvm.intr.lifetime.end 16, %30 : !llvm.ptr
    }
    llvm.call @nvshmem_barrier_all() : () -> ()
    %72 = llvm.load %34 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %73 = llvm.load %35 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %72, %42 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %73, %43 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.intr.lifetime.start 16, %25 : !llvm.ptr
    llvm.intr.lifetime.start 16, %26 : !llvm.ptr
    llvm.store %0, %25 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %0, %26 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.call @nvshmem_barrier_all() {convergent, no_unwind} : () -> ()
    llvm.intr.lifetime.end 16, %25 : !llvm.ptr
    llvm.intr.lifetime.end 16, %26 : !llvm.ptr
    %74 = llvm.call @cudaMemcpy(%31, %49, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %75 = llvm.call @cudaMemcpy(%32, %50, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %76 = llvm.load %32 {alignment = 4 : i64} : !llvm.ptr -> i32
    %77 = llvm.load %31 {alignment = 4 : i64} : !llvm.ptr -> i32
    %78 = llvm.call @printf(%13, %46, %76, %77) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %79 = llvm.load %31 {alignment = 4 : i64} : !llvm.ptr -> i32
    %80 = llvm.load %32 {alignment = 4 : i64} : !llvm.ptr -> i32
    %81 = llvm.call @printf(%14, %46, %79, %80) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_free(%49) : (!llvm.ptr) -> ()
    llvm.call @nvshmem_free(%50) : (!llvm.ptr) -> ()
  ...
  llvm.func @nvshmem_quiet() attributes {frame_pointer = #llvm.framePointerKind<all>, passthrough = [["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"}
