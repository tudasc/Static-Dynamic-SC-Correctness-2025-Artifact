module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu", spmd.executionKind = "All"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], spmd.executionKind = "All", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %32 = llvm.alloca %c1_i32 x i32 {alignment = 4 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %33 = llvm.alloca %c1_i32 x !llvm.struct<"struct.dim3", (i32, i32, i32)> {alignment = 4 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %34 = llvm.alloca %c1_i32 x !llvm.struct<"struct.dim3", (i32, i32, i32)> {alignment = 4 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    ...
    %43 = "spmd.init"() <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : () -> !spmd.error
    %rank, %error = "spmd.getRankInComm"(%15) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm) -> (i32, !spmd.error)
    %44 = llvm.call @cudaSetDevice(%rank) {spmd.executionKind = "All"} : (i32) -> i32
    ...
    %45 = arith.cmpi ne, %size, %c2_i32 {spmd.executionKind = "All"} : i32
    scf.if %45 {
    ...
    %49 = llvm.getelementptr inbounds %34[0, 0] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %49 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %50 = llvm.getelementptr inbounds %34[0, 1] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %50 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %51 = llvm.getelementptr inbounds %34[0, 2] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %51 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %52 = "spmd.memset"(%address, %c0_i32, %c4_i64) <{usedModel = 4 : i32}> {spmd.executionKind = "All"} : (!llvm.ptr, i32, i64) -> !spmd.error
    %53 = "spmd.memset"(%address_4, %c1_i32, %c4_i64) <{usedModel = 4 : i32}> {spmd.executionKind = "All"} : (!llvm.ptr, i32, i64) -> !spmd.error
    %54 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (i32) -> !spmd.error
    %55 = llvm.load %33 {spmd.executionKind = "All"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %56 = llvm.load %34 {spmd.executionKind = "All"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    ...
    llvm.store %12, %30 {spmd.executionKind = "All"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    %57 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (i32) -> !spmd.error
    %58 = llvm.load %33 {spmd.executionKind = "All"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %59 = llvm.load %34 {spmd.executionKind = "All"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %58, %37 {spmd.executionKind = "All"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %59, %38 {spmd.executionKind = "All"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %60 = llvm.getelementptr %24[1] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %21, %60 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    ...
    %61 = arith.cmpi eq, %rank_6, %c0_i32 {spmd.executionKind = "All"} : i32
    scf.if %61 {
    ...
    %62 = arith.cmpi eq, %rank_0, %c0_i32 {spmd.executionKind = "All"} : i32
    scf.if %62 {
      %75 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (i32) -> !spmd.error
      %76 = llvm.load %33 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      %77 = llvm.load %34 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      llvm.store %76, %39 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %77, %40 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %12, %27 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %12, %28 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      %78 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (i32) -> !spmd.error
      %79 = "spmd.memcpy"(%32, %address_4, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
      %80 = llvm.load %32 {alignment = 4 : i64, spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.ptr -> i32
      %81 = llvm.call @printf(%2, %80) vararg(!llvm.func<i32 (ptr, ...)>) {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!llvm.ptr, i32) -> i32
    } else {
      %75 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executedNotBy = array<i32: 0>, spmd.executionKind = "AllBut"} : (i32) -> !spmd.error
      %76 = llvm.load %33 {spmd.executedNotBy = array<i32: 0>, spmd.executionKind = "AllBut"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      %77 = llvm.load %34 {spmd.executedNotBy = array<i32: 0>, spmd.executionKind = "AllBut"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      llvm.store %76, %41 {spmd.executedNotBy = array<i32: 0>, spmd.executionKind = "AllBut"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %77, %42 {spmd.executedNotBy = array<i32: 0>, spmd.executionKind = "AllBut"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %12, %25 {spmd.executedNotBy = array<i32: 0>, spmd.executionKind = "AllBut"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %12, %26 {spmd.executedNotBy = array<i32: 0>, spmd.executionKind = "AllBut"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      %78 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executedNotBy = array<i32: 0>, spmd.executionKind = "AllBut"} : (i32) -> !spmd.error
    } {spmd.executionKind = "All", spmd.isMultiValued = true}
    %63 = "spmd.memcpy"(%31, %address, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %64 = "spmd.memcpy"(%32, %address_4, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %65 = llvm.load %32 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
    %66 = llvm.load %31 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
    ...
    %69 = llvm.load %31 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
    %70 = llvm.load %32 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
