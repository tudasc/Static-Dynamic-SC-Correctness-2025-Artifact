module attributes {dlti.dl_spec = #dlti.dl_spec<i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu", spmd.executionKind = "All"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], spmd.executionKind = "All", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %16 = llvm.call @__cudaRegisterFatBinary(%8) {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr
    llvm.store %16, %9 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    %17 = llvm.call @__cudaRegisterFunction(%16, %7, %6, %6, %c-1_i32, %2, %2, %2, %2, %2) {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    %18 = llvm.call @__cudaRegisterFunction(%16, %5, %4, %4, %c-1_i32, %2, %2, %2, %2, %2) {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    llvm.call @__cudaRegisterFatBinaryEnd(%16) {spmd.executionKind = "All"} : (!llvm.ptr) -> ()
    %19 = llvm.call @atexit(%10) {spmd.executionKind = "All"} : (!llvm.ptr) -> i32
    ...
    scf.if %41 {
      %76 = llvm.call @printf(%3, %size, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) {spmd.executionKind = "All"} : (!llvm.ptr, i32, i32) -> i32
      %77 = "spmd.abort"(%14, %c1_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, i32) -> !spmd.error
    ...
    llvm.store %11, %28 {spmd.executionKind = "All"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    llvm.store %11, %23 {spmd.executionKind = "All"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    %57 = llvm.alloca %c1_i32 x i64 {alignment = 8 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    llvm.store %c0_i64, %57 {alignment = 8 : i64, spmd.executionKind = "All"} : i64, !llvm.ptr
    %rank_6, %error_7 = "spmd.getRankInComm"(%14) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm) -> (i32, !spmd.error)
    %58 = arith.cmpi eq, %rank_6, %c0_i32 {spmd.executionKind = "All"} : i32
    scf.if %58 {
      ...
      %win_9, %error_10 = "spmd.winCreate"(%14, %57, %c0_i32) <{usedModel = 2 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!spmd.comm, !llvm.ptr, i32) -> (!spmd.win, !spmd.error)
    ...
    %59 = arith.cmpi eq, %rank_0, %c0_i32 {spmd.executionKind = "All"} : i32
    scf.if %59 {
      %76 = "spmd.memset"(%address_4, %c42_i32, %c4_i64) <{usedModel = 4 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!llvm.ptr, i32, i64) -> !spmd.error
    } {spmd.executionKind = "All", spmd.isMultiValued = true}
    %60 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (i32) -> !spmd.error
    %61 = llvm.load %31 {spmd.executionKind = "All"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %62 = llvm.load %32 {spmd.executionKind = "All"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %61, %37 {spmd.executionKind = "All"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %64 = "spmd.memcpy"(%29, %address, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %65 = "spmd.memcpy"(%30, %address_4, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %66 = llvm.load %30 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
    %67 = llvm.load %29 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
    %68 = llvm.call @printf(%1, %rank_0, %66, %67) vararg(!llvm.func<i32 (ptr, ...)>) {spmd.executionKind = "All"} : (!llvm.ptr, i32, i32, i32) -> i32
    %69 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (i32) -> !spmd.error
    ...
    %72 = llvm.call @printf(%0, %rank_0, %70, %71) vararg(!llvm.func<i32 (ptr, ...)>) {spmd.executionKind = "All"} : (!llvm.ptr, i32, i32, i32) -> i32
    %73 = "spmd.free"(%14, %address) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %74 = "spmd.free"(%14, %address_4) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %75 = "spmd.finalize"() <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : () -> !spmd.error
