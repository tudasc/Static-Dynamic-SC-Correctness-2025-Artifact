module attributes {dlti.dl_spec = #dlti.dl_spec<i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %27 = llvm.alloca %c1_i32 x !llvm.array<2 x ptr> {alignment = 16 : i64} : (i32) -> !llvm.ptr
    ...
    scf.if %40 {
      %74 = llvm.call @printf(%8, %39, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
    ...
    llvm.store %41, %27 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %43 = llvm.getelementptr inbounds %27[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %42, %43 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %44 = llvm.getelementptr inbounds %28[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %44 {alignment = 4 : i64} : i32, !llvm.ptr
    %45 = llvm.getelementptr inbounds %28[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %45 {alignment = 4 : i64} : i32, !llvm.ptr
    %46 = llvm.getelementptr inbounds %28[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %46 {alignment = 4 : i64} : i32, !llvm.ptr
    %47 = llvm.getelementptr inbounds %29[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %47 {alignment = 4 : i64} : i32, !llvm.ptr
    %48 = llvm.getelementptr inbounds %29[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %48 {alignment = 4 : i64} : i32, !llvm.ptr
    %49 = llvm.getelementptr inbounds %29[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %49 {alignment = 4 : i64} : i32, !llvm.ptr
    %50 = llvm.call @cudaMemset(%41, %c0_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    %51 = llvm.call @cudaMemset(%42, %c1_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %52 = llvm.load %28 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %53 = llvm.load %29 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %52, %30 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %53, %31 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %56 = llvm.getelementptr inbounds %27[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2 x ptr>
    llvm.store %54, %32 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %55, %33 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    %57 = llvm.load %56 {alignment = 8 : i64} : !llvm.ptr -> !llvm.ptr
    %58 = llvm.getelementptr %56[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    ...
    llvm.store %57, %16 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %59, %17 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %16, %20 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %60 = llvm.getelementptr %20[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %17, %60 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %0, %18 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %0, %19 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    %61 = llvm.call @nvshmem_my_pe() {convergent, no_unwind} : () -> i32
    %62 = arith.cmpi eq, %61, %c0_i32 : i32
    scf.if %62 {
      llvm.call @nvshmem_int_put_nbi(%57, %59, %c1_i64, %c1_i32) {convergent, no_unwind} : (!llvm.ptr, !llvm.ptr, i64, i32) -> ()
    }
    ...
    %63 = arith.cmpi eq, %38, %c0_i32 : i32
    scf.if %63 {
      llvm.call @nvshmem_int_put_nbi(%41, %42, %c1_i64, %c0_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> ()
    }
    llvm.call @nvshmem_barrier_all() : () -> ()
    %64 = llvm.load %28 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %65 = llvm.load %29 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %64, %34 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %65, %35 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %66 = llvm.call @cudaMemcpy(%25, %41, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %67 = llvm.call @cudaMemcpy(%26, %42, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %68 = llvm.load %26 {alignment = 4 : i64} : !llvm.ptr -> i32
    %69 = llvm.load %25 {alignment = 4 : i64} : !llvm.ptr -> i32
    %70 = llvm.call @printf(%10, %38, %68, %69) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %71 = llvm.load %25 {alignment = 4 : i64} : !llvm.ptr -> i32
    %72 = llvm.load %26 {alignment = 4 : i64} : !llvm.ptr -> i32
    %73 = llvm.call @printf(%11, %38, %71, %72) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
