module attributes {dlti.dl_spec = #dlti.dl_spec<f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    scf.if %40 {
      %70 = llvm.call @printf(%8, %39, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
    ...
    %54 = llvm.load %29 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %53, %32 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %54, %33 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %55 = llvm.getelementptr %21[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %18, %55 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %0, %19 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %0, %20 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    %56 = llvm.alloca %c1_i32 x i64 {alignment = 8 : i64} : (i32) -> !llvm.ptr
    llvm.store %c0_i64, %56 {alignment = 8 : i64} : i64, !llvm.ptr
    %57 = llvm.call @nvshmem_my_pe() {convergent, no_unwind} : () -> i32
    %58 = arith.cmpi eq, %57, %c0_i32 : i32
    scf.if %58 {
      llvm.call @nvshmem_int_put_signal_nbi(%41, %42, %c1_i64, %56, %c1_i64, %c9_i32, %c1_i32) {convergent, no_unwind} : (!llvm.ptr, !llvm.ptr, i64, !llvm.ptr, i64, i32, i32) -> ()
    }
    ...
    %59 = arith.cmpi eq, %38, %c0_i32 : i32
    scf.if %59 {
      %70 = llvm.call @cudaMemcpy(%27, %42, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
      %71 = llvm.load %27 {alignment = 4 : i64} : !llvm.ptr -> i32
      %72 = llvm.call @printf(%10, %71) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32) -> i32
    }
    llvm.call @nvshmem_barrier_all() : () -> ()
    %60 = llvm.load %28 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %61 = llvm.load %29 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %60, %34 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %61, %35 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %62 = llvm.call @cudaMemcpy(%26, %41, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %63 = llvm.call @cudaMemcpy(%27, %42, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %64 = llvm.load %27 {alignment = 4 : i64} : !llvm.ptr -> i32
    %65 = llvm.load %26 {alignment = 4 : i64} : !llvm.ptr -> i32
    %66 = llvm.call @printf(%11, %38, %64, %65) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %67 = llvm.load %26 {alignment = 4 : i64} : !llvm.ptr -> i32
    %68 = llvm.load %27 {alignment = 4 : i64} : !llvm.ptr -> i32
    %69 = llvm.call @printf(%12, %38, %67, %68) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
