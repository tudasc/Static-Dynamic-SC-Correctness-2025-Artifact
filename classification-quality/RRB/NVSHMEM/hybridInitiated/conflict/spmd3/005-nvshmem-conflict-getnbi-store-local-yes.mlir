module attributes {dlti.dl_spec = #dlti.dl_spec<i32 = dense<32> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, !llvm.ptr = dense<64> : vector<4xi64>, f80 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %38 = "spmd.init"() <{usedModel = 2 : i32}> : () -> !spmd.error
    %rank, %error = "spmd.getRankInComm"(%14) <{usedModel = 2 : i32}> : (!spmd.comm) -> (i32, !spmd.error)
    %39 = llvm.call @cudaSetDevice(%rank) : (i32) -> i32
    ...
    %40 = arith.cmpi ne, %size, %c2_i32 : i32
    scf.if %40 {
      %74 = llvm.call @printf(%3, %size, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
      %75 = "spmd.abort"(%13, %c1_i32) <{usedModel = 2 : i32}> : (!spmd.comm, i32) -> !spmd.error
    }
    ...
    %41 = llvm.getelementptr inbounds %30[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %41 {alignment = 4 : i64} : i32, !llvm.ptr
    %42 = llvm.getelementptr inbounds %30[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %42 {alignment = 4 : i64} : i32, !llvm.ptr
    %43 = llvm.getelementptr inbounds %30[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %43 {alignment = 4 : i64} : i32, !llvm.ptr
    %44 = llvm.getelementptr inbounds %31[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %44 {alignment = 4 : i64} : i32, !llvm.ptr
    %45 = llvm.getelementptr inbounds %31[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %45 {alignment = 4 : i64} : i32, !llvm.ptr
    %46 = llvm.getelementptr inbounds %31[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %46 {alignment = 4 : i64} : i32, !llvm.ptr
    %47 = "spmd.memset"(%address, %c0_i32, %c4_i64) <{usedModel = 4 : i32}> : (!llvm.ptr, i32, i64) -> !spmd.error
    %48 = "spmd.memset"(%address_4, %c1_i32, %c4_i64) <{usedModel = 4 : i32}> : (!llvm.ptr, i32, i64) -> !spmd.error
    %49 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> : (i32) -> !spmd.error
    %50 = llvm.load %30 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %51 = llvm.load %31 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %50, %32 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %53 = llvm.load %30 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    ...
    llvm.store %address, %19 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %address_4, %20 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.store %19, %23 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %55 = llvm.getelementptr %23[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %20, %55 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    ...
    %56 = arith.cmpi eq, %rank_6, %c0_i32 : i32
    scf.if %56 {
    ...
    %57 = arith.cmpi eq, %rank_0, %c0_i32 : i32
    scf.if %57 {
      %74 = "spmd.memset"(%address_4, %c42_i32, %c4_i64) <{usedModel = 4 : i32}> : (!llvm.ptr, i32, i64) -> !spmd.error
    }
    %58 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> : (i32) -> !spmd.error
    %59 = llvm.load %30 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %60 = llvm.load %31 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %59, %36 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %62 = "spmd.memcpy"(%28, %address, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %63 = "spmd.memcpy"(%29, %address_4, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %64 = llvm.load %29 {alignment = 4 : i64} : !llvm.ptr -> i32
    %65 = llvm.load %28 {alignment = 4 : i64} : !llvm.ptr -> i32
    %66 = llvm.call @printf(%1, %rank_0, %64, %65) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    ...
    %70 = llvm.call @printf(%0, %rank_0, %68, %69) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    %71 = "spmd.free"(%13, %address) <{usedModel = 2 : i32}> : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %72 = "spmd.free"(%13, %address_4) <{usedModel = 2 : i32}> : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %73 = "spmd.finalize"() <{usedModel = 2 : i32}> : () -> !spmd.error
