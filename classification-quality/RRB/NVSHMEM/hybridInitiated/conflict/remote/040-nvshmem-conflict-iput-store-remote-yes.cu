...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_iput@25","cudaMemcpy@75"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations iput and store executed concurrently which leads to a race."
}
*/
// RACE LABELS END
...
__global__ void nvshmem_kernel(int *remote, int *localbuf) {
    ...
    if (my_pe == 0) {
        ...
        nvshmem_int_iput(remote, localbuf, 1, 1, 1, 1);
    }
}
