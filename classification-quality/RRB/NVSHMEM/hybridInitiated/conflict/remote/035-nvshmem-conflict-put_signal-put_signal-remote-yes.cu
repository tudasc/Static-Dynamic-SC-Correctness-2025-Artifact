...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_put_signal@26","nvshmem_int_put_signal@76"],
    "NPROCS": 3,
...
__global__ void nvshmem_kernel(int *remote, int *localbuf) {
    ...
    if (my_pe == 0) {
        ...
        nvshmem_int_put_signal(remote, localbuf, 1, &ps_sig_addr, 1, NVSHMEM_SIGNAL_SET, 1);
    }
}
...
int main(int argc, char **argv) {
    ...
    if (my_pe == 2) {
        // CONFLICT
        nvshmem_int_put_signal(remote_d, localbuf_d, 1, &ps_sig_addr, 1, NVSHMEM_SIGNAL_SET, 1);
    }
