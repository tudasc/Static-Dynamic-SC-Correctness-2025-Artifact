module attributes {dlti.dl_spec = #dlti.dl_spec<i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %6 = llvm.call @nvshmem_team_my_pe(%c2_i32) : (i32) -> i32
    %7 = llvm.call @cudaSetDevice(%6) : (i32) -> i32
    %8 = llvm.call @nvshmem_my_pe() : () -> i32
    %9 = llvm.call @nvshmem_n_pes() : () -> i32
    %10 = arith.cmpi ne, %9, %c2_i32 : i32
    scf.if %10 {
      %24 = llvm.call @printf(%0, %9, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
    ...
    %13 = llvm.call @cudaMemset(%11, %c0_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    %14 = llvm.call @cudaMemset(%12, %c1_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %15 = arith.cmpi eq, %8, %c0_i32 : i32
    scf.if %15 {
      llvm.call @nvshmem_int_get_nbi(%12, %11, %c1_i64, %c1_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> ()
      %24 = llvm.call @cudaMemcpy(%5, %12, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
      %25 = llvm.load %5 {alignment = 4 : i64} : !llvm.ptr -> i32
      %26 = llvm.call @printf(%1, %25) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32) -> i32
      llvm.call @nvshmem_quiet() : () -> ()
    }
    llvm.call @nvshmem_barrier_all() : () -> ()
    %16 = llvm.call @cudaMemcpy(%4, %11, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %17 = llvm.call @cudaMemcpy(%5, %12, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %18 = llvm.load %5 {alignment = 4 : i64} : !llvm.ptr -> i32
    %19 = llvm.load %4 {alignment = 4 : i64} : !llvm.ptr -> i32
    %20 = llvm.call @printf(%2, %8, %18, %19) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %21 = llvm.load %4 {alignment = 4 : i64} : !llvm.ptr -> i32
    %22 = llvm.load %5 {alignment = 4 : i64} : !llvm.ptr -> i32
    %23 = llvm.call @printf(%3, %8, %21, %22) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
