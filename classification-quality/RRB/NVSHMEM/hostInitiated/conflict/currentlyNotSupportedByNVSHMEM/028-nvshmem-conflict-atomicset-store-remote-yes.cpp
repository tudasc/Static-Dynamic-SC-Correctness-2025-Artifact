...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_atomic_set@52","cudaMemcpy@58"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations atomicset and store executed concurrently which leads to a race."
}
*/
// RACE LABELS END
