...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_put@52","nvshmem_int_atomic_fetch@57"],
    "NPROCS": 3,
    "DESCRIPTION": "Two conflicting operations put and atomicfetch executed concurrently which leads to a race."
}
*/
// RACE LABELS END
...
int main(int argc, char **argv) {
    ...
    if (my_pe == 2) {
        // CONFLICT
        nvshmem_int_atomic_fetch(localbuf_d, remote_d, 1);
    }
