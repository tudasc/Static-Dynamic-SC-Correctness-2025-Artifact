...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_atomic_fetch@52","cudaMemcpy@58"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations atomicfetch and store executed concurrently which leads to a race."
}
*/
// RACE LABELS END
