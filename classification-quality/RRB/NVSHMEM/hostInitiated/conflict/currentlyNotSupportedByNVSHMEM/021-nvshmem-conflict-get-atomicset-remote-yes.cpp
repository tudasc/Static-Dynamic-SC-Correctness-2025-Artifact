...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_get@52","nvshmem_int_atomic_set@57"],
    "NPROCS": 3,
    "DESCRIPTION": "Two conflicting operations get and atomicset executed concurrently which leads to a race."
}
*/
// RACE LABELS END
