...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_atomic_fetch_nbi@52","cudaMemcpy@54"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations atomicfetchnbi and load executed concurrently which leads to a race."
}
*/
// RACE LABELS END
