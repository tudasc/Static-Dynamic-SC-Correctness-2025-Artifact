...
/*
{
    ...
    "NPROCS": 3,
    "DESCRIPTION": "Two non-conflicting operations atomicfetchinc and atomicfetchinc executed concurrently with no race."
}
*/
// RACE LABELS END
...
int main(int argc, char **argv) {
    ...
    if (my_pe == 0) {
        nvshmem_int_atomic_fetch_inc(localbuf_d, remote_d, 1);
    }
