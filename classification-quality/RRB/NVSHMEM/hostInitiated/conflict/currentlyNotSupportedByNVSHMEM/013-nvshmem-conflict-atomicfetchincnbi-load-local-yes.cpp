...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_atomic_fetch_inc_nbi@52","cudaMemcpy@54"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations atomicfetchincnbi and load executed concurrently which leads to a race."
}
*/
// RACE LABELS END
...
int main(int argc, char **argv) {
    ...
    if (my_pe == 0) {
        ...
        nvshmem_int_atomic_fetch_inc_nbi(localbuf_d, remote_d, 1);
