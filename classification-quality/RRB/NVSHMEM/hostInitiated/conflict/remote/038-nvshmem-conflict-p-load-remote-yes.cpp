...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_p@52","cudaMemcpy@57"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations p and load executed concurrently which leads to a race."
}
*/
// RACE LABELS END
