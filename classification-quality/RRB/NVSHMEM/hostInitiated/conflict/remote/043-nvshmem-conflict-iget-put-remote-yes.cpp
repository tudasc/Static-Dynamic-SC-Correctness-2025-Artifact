...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_iget@52","nvshmem_int_put@59"],
    "NPROCS": 3,
    "DESCRIPTION": "Two conflicting operations iget and put executed concurrently which leads to a race."
}
*/
// RACE LABELS END
...
int main(int argc, char **argv) {
    ...
    if (my_pe == 0) {
        // CONFLICT
        nvshmem_int_iget(localbuf_d, remote_d, 1, 1, 1, 1);
    }
