...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_put_signal@53","cudaMemcpy@59"],
    "NPROCS": 2,
    "DESCRIPTION": "Two conflicting operations putsignal and store executed concurrently which leads to a race."
}
*/
// RACE LABELS END
