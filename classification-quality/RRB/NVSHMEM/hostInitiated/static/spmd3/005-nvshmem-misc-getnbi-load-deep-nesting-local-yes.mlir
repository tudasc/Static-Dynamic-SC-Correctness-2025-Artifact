module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, f80 = dense<128> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %5 = "spmd.constDatatype"() <{typeAttr = i32, usedModel = 0 : i32}> : () -> !spmd.datatype
    %6 = "spmd.commWorld"() <{usedModel = 2 : i32}> : () -> !spmd.comm
    %7 = "spmd.commNode"() <{usedModel = 2 : i32}> : () -> !spmd.comm
    %8 = llvm.alloca %0 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
    %9 = llvm.alloca %c1_i32 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
    %10 = llvm.alloca %c1_i32 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
    %11 = "spmd.init"() <{usedModel = 2 : i32}> : () -> !spmd.error
    %rank, %error = "spmd.getRankInComm"(%7) <{usedModel = 2 : i32}> : (!spmd.comm) -> (i32, !spmd.error)
    %12 = llvm.call @cudaSetDevice(%rank) : (i32) -> i32
    %rank_0, %error_1 = "spmd.getRankInComm"(%6) <{usedModel = 2 : i32}> : (!spmd.comm) -> (i32, !spmd.error)
    %size, %error_2 = "spmd.getSizeOfComm"(%6) <{usedModel = 2 : i32}> : (!spmd.comm) -> (i32, !spmd.error)
    %13 = arith.cmpi ne, %size, %c2_i32 : i32
    scf.if %13 {
      %31 = llvm.call @printf(%1, %size, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
      %32 = "spmd.abort"(%6, %c1_i32) <{usedModel = 2 : i32}> : (!spmd.comm, i32) -> !spmd.error
    }
    %address, %error_3 = "spmd.malloc"(%6, %c4_i64) <{usedModel = 2 : i32}> : (!spmd.comm, i64) -> (!llvm.ptr, !spmd.error)
    %address_4, %error_5 = "spmd.malloc"(%6, %c4_i64) <{usedModel = 2 : i32}> : (!spmd.comm, i64) -> (!llvm.ptr, !spmd.error)
    %14 = "spmd.memset"(%address, %c0_i32, %c4_i64) <{usedModel = 4 : i32}> : (!llvm.ptr, i32, i64) -> !spmd.error
    %15 = "spmd.memset"(%address_4, %c1_i32, %c4_i64) <{usedModel = 4 : i32}> : (!llvm.ptr, i32, i64) -> !spmd.error
    %16 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> : (i32) -> !spmd.error
    %17 = arith.cmpi eq, %rank_0, %c0_i32 : i32
    scf.if %17 {
      %win, %error_6 = "spmd.winCreate"(%6, %address, %c0_i32) <{usedModel = 2 : i32}> : (!spmd.comm, !llvm.ptr, i32) -> (!spmd.win, !spmd.error)
      %error_7 = "spmd.get"(%address_4, %c1_i64, %5, %c1_i64, %c1_i32, %win, %c0_i64, %c1_i64, %5, %c1_i64) <{isAtomic = false, isBlocking = true, usedModel = 2 : i32}> : (!llvm.ptr, i64, !spmd.datatype, i64, i32, !spmd.win, i64, i64, !spmd.datatype, i64) -> !spmd.error
      %31 = "spmd.memcpy"(%8, %address_4, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
      %32 = llvm.load %8 {alignment = 4 : i64} : !llvm.ptr -> i32
      %33 = llvm.call @printf(%4, %32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32) -> i32
    }
    %18 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> : (i32) -> !spmd.error
    %19 = "spmd.memcpy"(%9, %address, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %20 = "spmd.memcpy"(%10, %address_4, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %21 = llvm.load %10 {alignment = 4 : i64} : !llvm.ptr -> i32
    %22 = llvm.load %9 {alignment = 4 : i64} : !llvm.ptr -> i32
    %23 = llvm.call @printf(%2, %rank_0, %21, %22) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    %24 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> : (i32) -> !spmd.error
    %25 = llvm.load %9 {alignment = 4 : i64} : !llvm.ptr -> i32
    %26 = llvm.load %10 {alignment = 4 : i64} : !llvm.ptr -> i32
    %27 = llvm.call @printf(%3, %rank_0, %25, %26) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    %28 = "spmd.free"(%6, %address) <{usedModel = 2 : i32}> : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %29 = "spmd.free"(%6, %address_4) <{usedModel = 2 : i32}> : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %30 = "spmd.finalize"() <{usedModel = 2 : i32}> : () -> !spmd.error
