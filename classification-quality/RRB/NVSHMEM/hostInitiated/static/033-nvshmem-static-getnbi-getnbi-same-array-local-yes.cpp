...
int main(int argc, char **argv) {
    ...
    int* localb_midp_d = localb_base_d + 1;
    int* remote_base_d = (int*)(nvshmem_malloc(sizeof(int) * ARR_SIZE));
    int* remote_midp_d = remote_base_d + 1;
    ...
    if (my_pe == 0) {
        // CONFLICT
        nvshmem_int_get_nbi(localb_base_d, remote_base_d, 2, 1);
        // CONFLICT
        nvshmem_int_get_nbi(localb_midp_d, remote_base_d, 1, 1);
    }
