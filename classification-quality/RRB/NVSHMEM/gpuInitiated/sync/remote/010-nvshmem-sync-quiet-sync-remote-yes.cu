...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_put@35","nvshmem_int_get@41"],
    "NPROCS": 2,
    "CONSISTENCY_CALLS": ["nvshmem_quiet"],
    "SYNC_CALLS": ["nvshmem_barrier_all"],
    "DESCRIPTION": "Two conflicting operations put and get where a missing process synchronization call between them leads to a race. Calling nvshmem_quiet is not sufficient here."
}
*/
// RACE LABELS END
