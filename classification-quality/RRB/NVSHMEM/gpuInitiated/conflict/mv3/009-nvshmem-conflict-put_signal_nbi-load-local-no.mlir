module attributes {dlti.dl_spec = #dlti.dl_spec<f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu", spmd.executionKind = "All"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], spmd.executionKind = "All", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %c3_i64 = arith.constant {spmd.executionKind = "All"} 3 : i64
    %c1_i32 = arith.constant {spmd.executionKind = "All"} 1 : i32
    ...
    %5 = llvm.mlir.addressof @_Z29__device_stub__nvshmem_kernelPiS_Pm {spmd.executionKind = "All"} : !llvm.ptr
    ...
    %10 = "spmd.constSignalOpType"() <{stringAttr = "SET", usedModel = 2 : i32}> {spmd.executionKind = "All"} : () -> !spmd.signalOp
    ...
    %14 = llvm.call @__cudaRegisterFatBinary(%6) {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr
    llvm.store %14, %7 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    %15 = llvm.call @__cudaRegisterFunction(%14, %5, %4, %4, %c-1_i32, %2, %2, %2, %2, %2) {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    llvm.call @__cudaRegisterFatBinaryEnd(%14) {spmd.executionKind = "All"} : (!llvm.ptr) -> ()
    %16 = llvm.call @atexit(%8) {spmd.executionKind = "All"} : (!llvm.ptr) -> i32
    %17 = llvm.alloca %c1_i32 x !llvm.ptr {alignment = 8 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %18 = llvm.alloca %c1_i32 x !llvm.ptr {alignment = 8 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %19 = llvm.alloca %c1_i32 x !llvm.ptr {alignment = 8 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %20 = llvm.alloca %c1_i32 x !llvm.struct<(i64, i32)> {alignment = 8 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %21 = llvm.alloca %c1_i32 x !llvm.struct<(i64, i32)> {alignment = 8 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %22 = llvm.alloca %c3_i64 x !llvm.ptr {alignment = 16 : i64, spmd.executionKind = "All"} : (i64) -> !llvm.ptr
    %23 = llvm.alloca %c1_i32 x i32 {alignment = 4 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %24 = llvm.alloca %c1_i32 x i32 {alignment = 4 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %25 = llvm.alloca %c1_i32 x !llvm.array<3 x ptr> {alignment = 16 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %26 = llvm.alloca %c1_i32 x !llvm.struct<"struct.dim3", (i32, i32, i32)> {alignment = 4 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %27 = llvm.alloca %c1_i32 x !llvm.struct<"struct.dim3", (i32, i32, i32)> {alignment = 4 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %28 = llvm.alloca %c1_i32 x !llvm.struct<(i64, i32)> {alignment = 4 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %29 = llvm.alloca %c1_i32 x !llvm.struct<(i64, i32)> {alignment = 4 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %30 = "spmd.init"() <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : () -> !spmd.error
    %rank, %error = "spmd.getRankInComm"(%13) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm) -> (i32, !spmd.error)
    %31 = llvm.call @cudaSetDevice(%rank) {spmd.executionKind = "All"} : (i32) -> i32
    ...
    %32 = arith.cmpi ne, %size, %c2_i32 {spmd.executionKind = "All"} : i32
    scf.if %32 {
      %70 = llvm.call @printf(%3, %size, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) {spmd.executionKind = "All"} : (!llvm.ptr, i32, i32) -> i32
      %71 = "spmd.abort"(%12, %c1_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, i32) -> !spmd.error
    ...
    %address_6, %error_7 = "spmd.malloc"(%12, %c8_i64) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, i64) -> (!llvm.ptr, !spmd.error)
    llvm.store %address, %25 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    %33 = llvm.getelementptr inbounds %25[1] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %address_4, %33 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    %34 = llvm.getelementptr inbounds %25[2] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %address_6, %34 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    %35 = llvm.getelementptr inbounds %26[0, 0] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %35 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %36 = llvm.getelementptr inbounds %26[0, 1] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %36 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %37 = llvm.getelementptr inbounds %26[0, 2] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %37 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %38 = llvm.getelementptr inbounds %27[0, 0] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %38 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %39 = llvm.getelementptr inbounds %27[0, 1] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %39 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %40 = llvm.getelementptr inbounds %27[0, 2] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %40 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %41 = llvm.load %26 {spmd.executionKind = "All"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %42 = llvm.load %27 {spmd.executionKind = "All"} : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %43 = llvm.getelementptr inbounds %25[0, 0] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.array<3 x ptr>
    llvm.store %41, %28 {spmd.executionKind = "All"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %42, %29 {spmd.executionKind = "All"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    %44 = llvm.load %43 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr -> !llvm.ptr
    %45 = llvm.getelementptr %43[1] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    %46 = llvm.load %45 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr -> !llvm.ptr
    %47 = llvm.getelementptr %43[2] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    %48 = llvm.load %47 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr -> !llvm.ptr
    llvm.store %44, %17 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    llvm.store %46, %18 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    llvm.store %48, %19 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    llvm.store %17, %22 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    %49 = llvm.getelementptr %22[1] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %18, %49 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    %50 = llvm.getelementptr %22[2] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %19, %50 {alignment = 8 : i64, spmd.executionKind = "All"} : !llvm.ptr, !llvm.ptr
    llvm.store %9, %20 {spmd.executionKind = "All"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %9, %21 {spmd.executionKind = "All"} : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %c0_i32, %44 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    llvm.store %c1_i32, %46 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    llvm.store %c0_i64, %48 {alignment = 8 : i64, spmd.executionKind = "All"} : i64, !llvm.ptr
    %rank_8, %error_9 = "spmd.getRankInComm"(%12) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm) -> (i32, !spmd.error)
    %51 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (i32) -> !spmd.error
    %52 = arith.cmpi eq, %rank_8, %c0_i32 {spmd.executionKind = "All"} : i32
    %53 = scf.if %52 -> (i32) {
      %win, %error_10 = "spmd.winCreate"(%12, %44, %c0_i32) <{usedModel = 2 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!spmd.comm, !llvm.ptr, i32) -> (!spmd.win, !spmd.error)
      %win_11, %error_12 = "spmd.winCreate"(%12, %48, %c0_i32) <{usedModel = 2 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!spmd.comm, !llvm.ptr, i32) -> (!spmd.win, !spmd.error)
      %error_13 = "spmd.putSignal"(%46, %c1_i64, %11, %c1_i64, %c1_i32, %win, %c0_i64, %c1_i64, %11, %c1_i64, %win_11, %c1_i64, %10) <{isAtomic = true, isBlocking = true, usedModel = 2 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!llvm.ptr, i64, !spmd.datatype, i64, i32, !spmd.win, i64, i64, !spmd.datatype, i64, !spmd.win, i64, !spmd.signalOp) -> !spmd.error
      %70 = llvm.load %46 {alignment = 4 : i64, spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.ptr -> i32
      scf.yield {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} %70 : i32
    } else {
    ...
    %55 = llvm.load %44 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
    %56 = arith.addi %55, %53 {spmd.executionKind = "All"} : i32
    llvm.store %56, %44 {alignment = 4 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %57 = "spmd.memcpy"(%23, %address, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %58 = "spmd.memcpy"(%24, %address_4, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %59 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (i32) -> !spmd.error
    %60 = llvm.load %24 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
    %61 = llvm.load %23 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
    %62 = llvm.call @printf(%1, %rank_0, %60, %61) vararg(!llvm.func<i32 (ptr, ...)>) {spmd.executionKind = "All"} : (!llvm.ptr, i32, i32, i32) -> i32
    %63 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (i32) -> !spmd.error
    %64 = llvm.load %23 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
    %65 = llvm.load %24 {alignment = 4 : i64, spmd.executionKind = "All"} : !llvm.ptr -> i32
    %66 = llvm.call @printf(%0, %rank_0, %64, %65) vararg(!llvm.func<i32 (ptr, ...)>) {spmd.executionKind = "All"} : (!llvm.ptr, i32, i32, i32) -> i32
    %67 = "spmd.free"(%12, %address) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %68 = "spmd.free"(%12, %address_4) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %69 = "spmd.finalize"() <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : () -> !spmd.error
