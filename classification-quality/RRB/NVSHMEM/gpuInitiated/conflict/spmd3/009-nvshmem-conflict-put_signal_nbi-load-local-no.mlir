module attributes {dlti.dl_spec = #dlti.dl_spec<f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    scf.if %32 {
      %70 = llvm.call @printf(%3, %size, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
      %71 = "spmd.abort"(%12, %c1_i32) <{usedModel = 2 : i32}> : (!spmd.comm, i32) -> !spmd.error
    }
    ...
    %53 = scf.if %52 -> (i32) {
      ...
      %70 = llvm.load %46 {alignment = 4 : i64} : !llvm.ptr -> i32
      scf.yield %70 : i32
    } else {
      scf.yield %c0_i32 : i32
    }
    %54 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> : (i32) -> !spmd.error
    %55 = llvm.load %44 {alignment = 4 : i64} : !llvm.ptr -> i32
    %56 = arith.addi %55, %53 : i32
    llvm.store %56, %44 {alignment = 4 : i64} : i32, !llvm.ptr
    %57 = "spmd.memcpy"(%23, %address, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %58 = "spmd.memcpy"(%24, %address_4, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %59 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> : (i32) -> !spmd.error
    %60 = llvm.load %24 {alignment = 4 : i64} : !llvm.ptr -> i32
    %61 = llvm.load %23 {alignment = 4 : i64} : !llvm.ptr -> i32
    %62 = llvm.call @printf(%1, %rank_0, %60, %61) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    %63 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> : (i32) -> !spmd.error
    %64 = llvm.load %23 {alignment = 4 : i64} : !llvm.ptr -> i32
    %65 = llvm.load %24 {alignment = 4 : i64} : !llvm.ptr -> i32
    %66 = llvm.call @printf(%0, %rank_0, %64, %65) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    %67 = "spmd.free"(%12, %address) <{usedModel = 2 : i32}> : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %68 = "spmd.free"(%12, %address_4) <{usedModel = 2 : i32}> : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %69 = "spmd.finalize"() <{usedModel = 2 : i32}> : () -> !spmd.error
