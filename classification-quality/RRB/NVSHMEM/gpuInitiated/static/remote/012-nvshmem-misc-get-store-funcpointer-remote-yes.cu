...
/*
{
    ...
    "RACE_PAIR": ["nvshmem_int_get@22","STORE@26"],
    "NPROCS": 2,
...
__device__  __attribute__((noinline)) void rank0(int* rem_ptr, int* lbuf_ptr) {
    nvshmem_int_get(lbuf_ptr, rem_ptr, 1, 1);
}

__device__  __attribute__((noinline)) void rank1(int* rem_ptr, int* lbuf_ptr) {
    *rem_ptr = 42;
}
