...
#di_file = #llvm.di_file<"results-20250730-140308/SPMDIR/hybrid/006-MPI-hybrid-for-local-yes.c" in "/home/yo30qaqy/data-race-detection-benchmark-suite">
  ...
  llvm.func local_unnamed_addr @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {no_unwind, passthrough = [["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], spmd.executionKind = "All", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    scf.if %18 {
      scf.for %arg2 = %c0_i32 to %c2_i32 step %c1_i32  : i32 {
        %24 = arith.cmpi eq, %arg2, %c0_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        scf.if %24 {
          %25 = "spmd.lock"(%c1_i32, %win, %5, %c0_i32) <{usedModel = 0 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (i32, !spmd.win, !spmd.lock, i32) -> !spmd.error
          %error_5 = "spmd.get"(%baseAddress, %c1_i64, %6, %c1_i64, %c1_i32, %win, %c0_i64, %c1_i64, %6, %c1_i64) <{isAtomic = true, isBlocking = false, usedModel = 0 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!llvm.ptr, i64, !spmd.datatype, i64, i32, !spmd.win, i64, i64, !spmd.datatype, i64) -> !spmd.error
          %26 = "spmd.unlock"(%c1_i32, %win) <{usedModel = 0 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (i32, !spmd.win) -> !spmd.error
        } else {
          %25 = llvm.load %baseAddress {alignment = 4 : i64, spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static", tbaa = [#tbaa_tag]} : !llvm.ptr -> i32
          %26 = llvm.call @printf(%1, %25) vararg(!llvm.func<i32 (ptr, ...)>) {no_unwind, spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!llvm.ptr, i32) -> i32
        } {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static", spmd.isMultiValued = false}
      } {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static", spmd.isMultiValued = false}
      %error_4 = "spmd.barrier"(%4) <{isBlocking = true, usedModel = 0 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!spmd.comm) -> !spmd.error
