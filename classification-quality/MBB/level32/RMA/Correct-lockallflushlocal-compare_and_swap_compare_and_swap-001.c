...
BEGIN_MBB_TESTS
  $ mpirun -np 2 ${EXE}
  | OK
  | Correct-lockallflushlocal-compare_and_swap_compare_and_swap
END_MBB_TESTS
//////////////////////       End of MBI headers        /////////////////// */
...
int main(int argc, char **argv) {
  ...
  if (rank == 0) {
    ...
    int *int_2 = (int *)calloc(10, sizeof(int));

    int *int_3 = (int *)calloc(10, sizeof(int));

    MPI_Compare_and_swap(buf, int_3, int_2, MPI_INT, 0, 0, mpi_win_0);
  }
